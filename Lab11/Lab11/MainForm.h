...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Побудова графіку функції на проміжку [xn, xk]";
			...
			this->label2->Text = L"Введіть інтервал побудови графіка";
			// 
			// label3
			// 
			...
			this->label3->Text = L"Введіть початкове значення XN =";
			// 
			// label4
			// 
			...
			this->label4->Text = L"Введіть кінцеве значення      XK =";
			// 
			// label5
			// 
			...
			this->label5->Text = L"Введіть значення кроку         XH =";
			// 
			// textBox1
			// 
			...
			this->button1->Text = L"Намалювати графік";
			...
			this->Text = L"Виконав Малород М.М";
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (textBox1->Text != "" && textBox2->Text != "" && textBox3->Text != "")
		{
			...
			if (xn >= xk || xh > (xk - xn))
			{
				MessageBox::Show("Данні заповнені невірно!", "Помилка ввода даних!",
		...
		{
			MessageBox::Show("Заповніть будьла-ласка дані", "Помилка ввода даних!",
			MessageBoxButtons::OK, MessageBoxIcon::Exclamation);
		}
	}
