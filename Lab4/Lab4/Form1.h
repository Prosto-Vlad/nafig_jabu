...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Text = L"Введіть текст";
			// 
			// textBox2
			// 
			...
			this->button1->Text = L"Вивід тесту";
			...
			this->button2->Text = L"Запус форми";
			...
			this->groupBox2->Text = L"Колір шрифта";
			// 
			// radioButton5
			// 
			...
			this->Name = L"Form1";
			this->Text = L"Лаб 4. Виконав Малород М.М. 41 КІ";
